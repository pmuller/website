...
function resolvePlugin(plugin, rootDir) {
  const pluginName = (0, _lodash.isString)(plugin) ? plugin : plugin.resolve; // Handle local plugins
  ...
  if (validLocalPlugin && localPluginPath) {
    ...
    return {
      ...
      version: packageJSON.version || (0, _createHash.createFileContentHash)(localPluginPath, `**`)
    };
  }
  /**
