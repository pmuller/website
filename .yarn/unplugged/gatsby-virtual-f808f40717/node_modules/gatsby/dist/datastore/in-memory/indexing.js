...
exports.getNodesFromCacheByValue = exports.ensureIndexByElemMatch = exports.ensureIndexByQuery = exports.getGatsbyNodePartial = void 0;
...
const getGatsbyNodePartial = (node, indexFields, resolvedFields) => {
  ...
  if (nodeIdToIdentifierMap.has(cacheKey)) {
    ...
    if (derefPartial && _lodash.default.every(indexFields.map(field => derefPartial.gatsbyNodePartialInternalData.indexFields.has(field)))) {
      return derefPartial;
    }
